...
Now this is where decompilation gets harder. Ghidra does its best with what it has, but we both know that doesn't look like C.
...
Now that we have our decompiled C program, put it all together to get 
...
And out [actual program](https://github.com/lookie27/ghidra-hello-world/blob/master/HelloWorld.c) looked like
